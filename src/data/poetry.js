...
const poetry = {
  ...
  xiamen: [
    {
      title: '致橡树（节选）',
      titleEn: 'To the Oak Tree (excerpt)',
      author: '舒婷',
      authorEn: 'Shu Ting',
      dynasty: '当代（1977年，作于鼓浪屿）',
      dynastyEn: 'Contemporary (1977, written on Gulangyu Island)',
      lines: [
        '我如果爱你——',
        '绝不像攀援的凌霄花，借你的高枝炫耀自己；',
        '我如果爱你——',
      ...
      linesEn: [
        'If I love you —',
        'I will never be like a clinging trumpet vine,',
        'Using your towering branches to show myself off.',
        'If I love you —',
        'I will not imitate the lovesick bird',
        'That sings the same song over and over in your shade.',
        'No — none of these are enough!',
        'I must be a kapok tree standing beside you,',
        'An image of a tree, standing as your equal.',
        'Our roots entangle deep beneath the earth;',
        'Our leaves touch among the clouds.',
        'With every gust of wind, we nod to each other —',
        'But no one understands what we say.',
      ],
      context: 'Shu Ting was born in Xiamen in 1952 and wrote this landmark poem on Gulangyu Island in 1977. It became the defining love poem of China\'s Reform era — a feminist declaration of equal, independent love. A bronze oak tree sculpture at Xiamen University\'s Furong Tunnel commemorates the poem to this day.',
      contextZh: '舒婷1952年生于厦门，1977年在鼓浪屿写下这首诗。《致橡树》成为中国改革开放时代最具代表性的爱情诗，以平等、独立的爱情观震撼了一代读者。厦门大学芙蓉隧道至今矗立着一棵铜制橡树雕塑，以纪念这首诗。',
    },
  ],
